    ...
    <header className={styles.header}>
      <div className={styles.container}>
        ...
        <div className={styles.navActions}>
          ...
          >
            {isMobile ? (
              <svg aria-label="New post" className={styles.icon} viewBox="0 0 24 24">
          ...
          {/* Additional nav icons like home, explore, messages */}
          <button className={styles.navIcon} aria-label="Home">
            <svg aria-label="Home" className={styles.icon} viewBox="0 0 24 24">
